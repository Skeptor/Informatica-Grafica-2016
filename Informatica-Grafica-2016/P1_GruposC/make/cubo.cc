...
#include "cubo.h"
	...
	Cubo::Cubo(){
		...
		/*Modificacion vertice pequeño: 5,5,5
		Cubo::Cubo(double 50f){
			50f=5;
		vertices.push_back(_vertex3f(50f*10,50f*10,50f*10));				//0
		vertices.push_back(_vertex3f(50f*10,50f*10,50f));				//1
		vertices.push_back(_vertex3f(50f*10,50f,50f*10));				//2
		vertices.push_back(_vertex3f(50f,50f*10,50f*10));				//3
		vertices.push_back(_vertex3f(50f*10,50f,50f));			//4
		vertices.push_back(_vertex3f(50f,50f*10,50f));			//5
		vertices.push_back(_vertex3f(50f,50f,50f*10));			//6
		vertices.push_back(_vertex3f(50f,50f,50f));			//7
